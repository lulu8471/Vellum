  ...
  Object.defineProperty(String.prototype, "split", {
    ...
    value(separator, limit) {
      ...
      if (
        ...
        separator.source === "\\r?\\n" &&
        /Commercial\s+Invoice/i.test(value) &&
        /Total\s+Weight/i.test(value)
      ) {
        document.documentElement.setAttribute("data-vellum-ocr-raw", value);
      }
      return nativeSplit.call(value, separator, limit);
    },
  });
